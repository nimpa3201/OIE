...
def predict(pred_config, doc_list, orignal):
    ...
    save_doc = []
    for doc in tqdm(doc_list, desc="Predicting"):

        lines, slot_label_mask = dict_to_sentence(doc)
        ...
        for words, preds in zip(orignal, preds_list):
            ...
            save_sentence.append(line)
        save_doc.append(save_sentence)
